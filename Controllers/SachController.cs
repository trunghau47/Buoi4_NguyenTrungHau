...
namespace Buoi4_NguyenTrungHau.Controllers
{
    public class SachController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            //đang bị cấn chỗ này, phải đưa nó cái list thể loại vào mới lấy đc, còn em dùng cái hồi nãy là nó chỉ hiện cái thể loại của sách thôi chứ ko hienj list đc vì nó là 1 sách có 1 thể loại
